...
1)Create new script.
2)Take inheritance from "IState".
3) Create new constructor method and add "PlayerController" value.
4) Add class  to PlayerStateManager as a variable.
5) Do assignment to PlayerStateManager constructor's method.
6) Finished. Your state is ready.
